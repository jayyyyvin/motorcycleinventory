          ...
          <div class="col-lg-7">
            <div class="p-5">
              ...
              <form action="{{ route('register.save') }}" method="POST" class="user">
                ...
                <div class="form-group">
                  <input name="role" type="text" class="form-control form-control-user @error('role')is-invalid @enderror" id="exampleInputEmail" placeholder="Role">
                  @error('role')
                    <span class="invalid-feedback">{{ $message }}</span>
                  @enderror
                </div>
                ...
                <div class="form-group">
                  <input name="status" type="name" class="form-control form-control-user @error('status')is-invalid @enderror" id="exampleInputEmail" placeholder="Status">
                  @error('status')
                    <span class="invalid-feedback">{{ $message }}</span>
                  @enderror
                </div>
